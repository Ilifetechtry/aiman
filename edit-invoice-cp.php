                                                    ...
                                                    <div class="row g-gs">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                <label for="city" class="form-label">Aadhar</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="aadhar" name="aadhar" autocomplete="off" placeholder="Enter Aadhar No" autosuggestion value=<?= $fc['aadhar'] ?> >
                                                                    <div id="results"></div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group"><label for="mobile_num" class="form-label">Mobile</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="tel" class="form-control" pattern="^[0-9]{10}$" id="mobile_num" name="mobile" placeholder="Enter your mobile number" value="<?= $fc['mobile'] ?>" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        ?>
                                                            <div class="row category_append mt-4">
                                                                <div class="col-lg-2 vav">
                                                                    <div class="form-group">
                                                                        <div class="form-control-wrap"><label for="" class="form-label">Bike Name<spam>*</spam></label>
