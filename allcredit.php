...
<div class="nk-block-head-content"><h2 class="nk-block-title">All Credit</h2><nav><ol class="breadcrumb breadcrumb-arrow mb-0"><li class="breadcrumb-item"><a href="#">Home</a></li><li class="breadcrumb-item active" aria-current="page">All Credit</li></ol></nav></div>
...
<th class="tb-col tb-col-md"><span class="overline-title">Total Amount</span></th>
...
?>
<td class="tb-col tb-col-md"><span>Rs.<?=$jj['total'];?></span></td>
<?php
}
?>
...
?>
<tfoot><tr>
    <td colspan="4" style="background-color:#15b423;color:white"></td>
...
<?php    
        ...
        ?>
        <td colspan="5"><center>No Credit Found</center></td>
        <?php
    }
}  
else{
    $c=1;
    $sel3=mysqli_query($conn,"SELECT * FROM credit1");
...
<?php
    ...
    $sel3a1=mysqli_query($conn,"SELECT sum(paid_amount) FROM credit1");
