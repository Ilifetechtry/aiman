...
<?php 
    $sel=mysqli_query($conn,"SELECT* FROM brand WHERE id='".$_GET['id']."' ");
...
<div class="nk-content">
        ...
        <div class="nk-block-head-content">
            <h2 class="nk-block-title">Edit brand</h1>
            <nav>
    ...
    <div class="nk-block-head-content"><ul class="d-flex">
        <li><a href="brand.php" class="btn btn-primary btn-md d-md-none"><em class="icon ni ni-eye"></em><span>View</span></a></li>
      </ul></div></div></div>
    <div class="nk-block">
<form method="post" enctype="multipart/form-data">
    ...
    <div class="col-lg-12">
    <div class="form-group"><label class="form-label">brand <spam>*</spam></label>
    <div class="form-control-wrap"><input type="text" class="form-control"  name="brand" value="<?=$fe['brand'];?>"></div></div></div>
...
<?php
    ...
    {
        $upd=mysqli_query($conn,"UPDATE brand 
