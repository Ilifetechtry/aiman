...
<body class="nk-body" data-sidebar-collapse="lg" data-navbar-collapse="lg" style="margin-top:50px">
    <div class="nk-content">
        <div class="container">
                        ...
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            ...
                            <div class="nk-block-head-content">
                                <ul class="d-flex">
                                    ...
                                    <li><a href="sales.php" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Invoice</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="nk-block">
                <div class="card">
                    <table class="datatable-init table" data-nk-container="table-responsive">
                        ...
                        <tbody>
                            ...
                            $sel = mysqli_query($conn, "SELECT * FROM customer1 ORDER BY date DESC");
                            $i = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td class="tb-col">
                                            <span>
                                                <?php if ($fe['mop'] == "UPI") {
                                                ?>
                                                    <span class="text-danger" style="text-transform:uppercase;font-size:13px;padding:5px 15px;border-radius:3px;font-weight:1000;"><?= $fe['mop']; ?></span>
                                                <?php
                                                }
                                                ?>
                                                <?php
                                                ...
                                                ?>
                                                    <span style="text-transform:uppercase;font-size:13px;padding:5px 15px;border-radius:3px;color:#2daae0;font-weight:1000;"><?= $fe['mop']; ?></span>
                                                <?php
                                                }
                                                ?>
                                                <?php
                                                ...
                                                ?>
                                                    <span class="text-white" style="background:black;text-transform:uppercase;font-size:13px;padding:5px 15px;border-radius:3px;font-weight:1000;"><?= $fe['mop']; ?></span>
                                                <?php
                                                }
                                                ?>
                                        ...
                                        <td class="tb-col tb-col-end">
                                            <div class="gap-col">
                                                ...
                                                <a href="billing-invoice1.php?id=<?= $fe['id']; ?>" class="btn btn-sm btn-lighter"> Preview </a>
                                            </div>
                </div>
                </td>
                ...
                <td class="tb-col tb-col-end">
                    <div class="gap-col">
                        <!-- <a href="edit-courier.php?id=<?= $fe['id']; ?>">
                            <em style="font-size:20px" class="icon ni ni-package-fill"></em>
                        </a> -->
                        <a href="edit-invoice.php?id=<?= $fe['id']; ?>" class="">
    ...
    ?>
    <script>
        let delete_url = 'delete-invoice.php?id=';
