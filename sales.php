                                        ...
                                        <div class="card card-gutter-md">
                                            <div class="card-body">
                                                <div class="row g-gs">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group"><label for="cus_gst" class="form-label">GST No</label>
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="cus_gst" name="cus_gst" placeholder="Enter Customer GST">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row category_append10 m-0 p-2 mt-3 mb-0 m-auto pt-3 pb-4 bt bg-light1">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select" id="chassis_no" name="chassis_no">
                                                                    <option value="" hidden>--- SELECT CHASSIS NO ---</option>
                                                                    <?php
                                                                    $sel = mysqli_query($conn, "SELECT chassis_no FROM book WHERE book_stock > 0 ORDER BY chassis_no ASC");
                                                                    while ($r = mysqli_fetch_assoc($sel)) {
                                                                        echo "<option value='{$r['chassis_no']}'>{$r['chassis_no']}</option>";
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="tprice1" class="form-control tp" readonly>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-3 mb-3">
                                                        <div class="form-group"><label for="date" class="form-label">charger No</label>
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="charger" name="charger" placeholder="Enter Bike Charge No">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <input type="text" class="form-control main_tax" id="cgst_tax" name="cgst" value=<?= $fes['cgst']; ?>>
                                                                    </div>
                                                                    <div class="col-6">
...
if (isset($_POST['save'])) {
    ...
    echo "POST['choose_name']", $_POST['choose_name'];
    if ($_POST['choose_name'] == 0) {
        $ins1 = mysqli_query($conn, "INSERT INTO customer (cname,date,mobile,city,address,aadhar,cus_gst)values('" . $_POST['cname'] . "','" . $_POST['date'] . "','" . $_POST['mobile'] . "','" . $_POST['city'] . "','" . $_POST['address'] . "','" . $_POST['aadhar'] . "','" . $_POST['cus_gst'] . "')");
        $customer_id = mysqli_insert_id($conn);
        $ins1a = mysqli_query($conn, "INSERT INTO invoice (cid,c_amount,r_amount,mop,discount,tax,total,net_amount,color,chassis,motor,controller,charger,batterymodel,batterysn,remarks,address,aadhar,brand)values($customer_id,'" . $_POST['c_amount'] . "','" . $_POST['r_amount'] . "','" . $_POST['mop'] . "','" . $_POST['main_discount1'] . "','" . $_POST['tax'] . "','" . $_POST['total'] . "','" . $_POST['net_amount'] . "','" . $_POST['color'] . "','" . $_POST['chassis_no'] . "','" . $_POST['motor'] . "','" . $_POST['controller'] . "','" . $_POST['charger'] . "','" . $_POST['batterymodel'] . "','" . $_POST['batterysn'] . "','" . $_POST['remarks'] . "','" . $_POST['address'] . "','" . $_POST['aadhar'] . "','" . $_POST['brand'] . "')");

        $ins2 = mysqli_query($conn, "INSERT INTO customer1 (cid,cname,date,mobile,city,c_amount,r_amount,mop,discount,tax,total,net_amount,credit_status,address,color,chassis,motor,controller,charger,batterymodel,batterysn,remarks,aadhar,cus_gst,cgst,hsn,brand)values($customer_id,'" . $_POST['cname'] . "','" . $_POST['date'] . "','" . $_POST['mobile'] . "','" . $_POST['city'] . "','" . $_POST['c_amount'] . "','" . $_POST['r_amount'] . "','" . $_POST['mop'] . "','" . $_POST['main_discount1'] . "','" . $_POST['tax'] . "','" . $_POST['total'] . "','" . $_POST['net_amount'] . "','" . $_POST['credit_status'] . "','" . $_POST['address'] . "','" . $_POST['color'] . "','" . $_POST['chassis_no'] . "','" . $_POST['motor'] . "','" . $_POST['controller'] . "','" . $_POST['charger'] . "','" . $_POST['batterymodel'] . "','" . $_POST['batterysn'] . "','" . $_POST['remarks'] . "','" . $_POST['aadhar'] . "','" . $_POST['cus_gst'] . "','" . $_POST['cgst'] . "','" . $_POST['hsn'] . "','" . $_POST['brand'] . "')");
        ...
        if (mysqli_num_rows($select_name) > 0) {
            ...
            $ins3 = mysqli_query($conn, "UPDATE customer set cname='" . $fech['cname'] . "',mobile='" . $_POST['mobile'] . "',city='" . $_POST['city'] . "',address='" . $_POST['address'] . "' where id='" . $_POST['choose_name'] . "'");
        }
        
        $ins3a = mysqli_query($conn, "INSERT INTO invoice (cid,c_amount,r_amount,mop,discount,tax,total,net_amount,date,color,chassis,motor,controller,charger,batterymodel,batterysn,remarks,address,aadhar,brand)VALUES('" . $_POST['choose_name'] . "','" . $_POST['c_amount'] . "','" . $_POST['r_amount'] . "','" . $_POST['mop'] . "','" . $_POST['main_discount1'] . "','" . $_POST['tax'] . "','" . $_POST['total'] . "','" . $_POST['net_amount'] . "','" . $_POST['date'] . "','" . $_POST['color'] . "','" . $_POST['chassis_no'] . "','" . $_POST['motor'] . "','" . $_POST['controller'] . "','" . $_POST['charger'] . "','" . $_POST['batterymodel'] . "','" . $_POST['batterysn'] . "','" . $_POST['remarks'] . "','" . $_POST['address'] . "','" . $_POST['aadhar'] . "','" . $_POST['brand'] . "')");


        $ins4 = mysqli_query($conn, "INSERT INTO customer1 (cid,cname,date,mobile,city,c_amount,r_amount,mop,discount,tax,total,net_amount,credit_status,color,chassis,motor,controller,charger,batterymodel,batterysn,remarks,address,aadhar,cus_gst,cgst,hsn,brand)values('" . $_POST['choose_name'] . "','" . $_POST['cname'] . "','" . $_POST['date'] . "','" . $_POST['mobile'] . "','" . $_POST['city'] . "','" . $_POST['c_amount'] . "','" . $_POST['r_amount'] . "','" . $_POST['mop'] . "','" . $_POST['main_discount1'] . "','" . $_POST['tax'] . "','" . $_POST['total'] . "','" . $_POST['net_amount'] . "','" . $_POST['credit_status'] . "','" . $_POST['color'] . "','" . $_POST['chassis_no'] . "','" . $_POST['motor'] . "','" . $_POST['controller'] . "','" . $_POST['charger'] . "','" . $_POST['batterymodel'] . "','" . $_POST['batterysn'] . "','" . $_POST['remarks'] . "','" . $_POST['address'] . "','" . $_POST['aadhar'] . "','" . $_POST['cus_gst'] . "','" . $_POST['cgst'] . "','" . $_POST['hsn'] . "','" . $_POST['brand'] . "')");
    ...
    if (mysqli_num_rows($select_all_data) > 0) {
        ...
        for ($i = 0; $i < $l; $i++) {
            $select_book = mysqli_query($conn, "SELECT * FROM book WHERE chassis_no='" . $_POST['chassis_no'] . "'");
            if (mysqli_num_rows($select_book) > 0) {
                ...
                $update_book = mysqli_query($conn, "UPDATE book SET book_stock='$final_stock' WHERE chassis_no='" . $_POST['chassis_no'] . "'");
            }
        }
    }
