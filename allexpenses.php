...
<div class="nk-block-head-content"><h2 class="nk-block-title">All Expenses</h2><nav><ol class="breadcrumb breadcrumb-arrow mb-0"><li class="breadcrumb-item"><a href="#">Home</a></li><li class="breadcrumb-item active" aria-current="page">All Expenses</li></ol></nav></div>
...
<?php    
    ...
    $c=1;
    $sel3=mysqli_query($conn,"SELECT * FROM expenses");
...
<?php
    ...
    $sel3a1=mysqli_query($conn,"SELECT sum(price) FROM expenses");
